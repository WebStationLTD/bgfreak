      ...
      <div class="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
        <div class="sm:max-w-lg">
          ...
          <p class="mt-4 text-xl text-white">
            Искаш да си купиш истински стероиди онлайн – направи го от най-големия реално работещ склад за анаболи – bgfreak.store777
          </p>
        </div>
        <div>
          <div class="mt-10">
            ...
            <NuxtLink
              to="/categories"
              class="inline-block relative z-10 cursor-pointer rounded-md border border-transparent bg-[#dd3737] px-8 py-3 text-center font-medium text-white hover:text-black hover:bg-[#ebedeb] transition-colors duration-300">
