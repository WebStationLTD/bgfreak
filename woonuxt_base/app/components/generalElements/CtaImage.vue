<script setup>
// Компонент, адаптиран от ctaImage.js
</script>
    ...
    <div class="relative mx-auto max-w-7xl py-12 sm:py-12 lg:px-8 lg:py-12">
      <div class="pr-6 pl-6 md:ml-auto md:w-2/3 md:pl-16 lg:w-1/2 lg:pr-0 lg:pl-24 xl:pl-32">
        ...
        <div class="mt-8">
          <NuxtLink
            to="/magazin"
            class="inline-flex rounded-md bg-[#dd3737] px-3.5 py-2.5 text-sm font-semibold text-white hover:text-black shadow-xs hover:bg-[#ebedeb] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">
            Пазарувайте онлайн
          </NuxtLink>
        </div>
      </div>
