...
const generateCategorySeoMeta = () => {
  ...
  const canonicalUrl =
    pageNumber === 1
      ? `${frontEndUrl || 'https://bgfreak.vercel.app'}/produkt-kategoriya/${slug}`
      : `${frontEndUrl || 'https://bgfreak.vercel.app'}/produkt-kategoriya/${slug}/page/${pageNumber}`;
...
const updateCategoryNextPrevLinks = () => {
  ...
  if (currentSeoMeta.pageNumber > 1) {
    const prevUrl =
      currentSeoMeta.pageNumber === 2
        ? `${frontEndUrl || 'https://bgfreak.vercel.app'}/produkt-kategoriya/${slug}`
        : `${frontEndUrl || 'https://bgfreak.vercel.app'}/produkt-kategoriya/${slug}/page/${currentSeoMeta.pageNumber - 1}`;
  ...
  if (hasNextPage) {
    const nextUrl = `${frontEndUrl || 'https://bgfreak.vercel.app'}/produkt-kategoriya/${slug}/page/${currentSeoMeta.pageNumber + 1}`;
