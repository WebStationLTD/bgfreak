...
const generateChildCategorySeoMeta = () => {
  ...
  const canonicalUrl =
    pageNumber === 1
      ? `${frontEndUrl || 'https://bgfreak.vercel.app'}/produkt-kategoriya/${parentSlug}/${childSlug}`
      : `${frontEndUrl || 'https://bgfreak.vercel.app'}/produkt-kategoriya/${parentSlug}/${childSlug}/page/${pageNumber}`;
...
const updateChildCategoryNextPrevLinks = () => {
  ...
  if (currentSeoMeta.pageNumber > 1) {
    const prevUrl =
      currentSeoMeta.pageNumber === 2
        ? `${frontEndUrl || 'https://bgfreak.vercel.app'}/produkt-kategoriya/${parentSlug}/${childSlug}`
        : `${frontEndUrl || 'https://bgfreak.vercel.app'}/produkt-kategoriya/${parentSlug}/${childSlug}/page/${currentSeoMeta.pageNumber - 1}`;
  ...
  if (hasNextPage) {
    const nextUrl = `${frontEndUrl || 'https://bgfreak.vercel.app'}/produkt-kategoriya/${parentSlug}/${childSlug}/page/${currentSeoMeta.pageNumber + 1}`;
