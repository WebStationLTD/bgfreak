...
const generateTagSeoMeta = () => {
  ...
  const canonicalUrl =
    pageNumber === 1
      ? `${frontEndUrl || 'https://bgfreak.vercel.app'}/produkt-etiket/${slug}`
      : `${frontEndUrl || 'https://bgfreak.vercel.app'}/produkt-etiket/${slug}/page/${pageNumber}`;
...
const updateTagNextPrevLinks = () => {
  ...
  if (currentSeoMeta.pageNumber > 1) {
    const prevUrl =
      currentSeoMeta.pageNumber === 2
        ? `${frontEndUrl || 'https://bgfreak.vercel.app'}/produkt-etiket/${slug}`
        : `${frontEndUrl || 'https://bgfreak.vercel.app'}/produkt-etiket/${slug}/page/${currentSeoMeta.pageNumber - 1}`;
  ...
  if (hasNextPage) {
    const nextUrl = `${frontEndUrl || 'https://bgfreak.vercel.app'}/produkt-etiket/${slug}/page/${currentSeoMeta.pageNumber + 1}`;
